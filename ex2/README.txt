...
The files that actually train various regression models and compare them are (among others) data_set_1_regr.py and data_set_1_regr.py for Colleges and Real Estate Valuation, respectively.
Some experimental results can also be found in the Results_X.txt files.

The code is also available on a public GitHub repo under https://github.com/amanfc7/Machine-Learaning/tree/main/ex2.
