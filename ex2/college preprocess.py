...
def preprocess_data(df, dataset_name, handle_missing=False, target_column=None):
    ...
    # to define the target column explicitly if provided:

    if target_column is None:
        target_column = df.columns[30]  
    ...
    columns_to_scale = ['agege24', 'faminc']  
...
college_data_after = preprocess_data(college_data.copy(), "College", handle_missing=True)
